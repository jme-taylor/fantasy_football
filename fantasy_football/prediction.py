...
from fantasy_football.fpl import get_players, get_fixtures
from fantasy_football.fpl_types import FplPlayer, FplFixtures, TeamFixture, PlayerExpectedPoints

def get_player_rolling_points(rolling_data: pl.DataFrame, player: FplPlayer, season: str = "2024-25") -> float:
...
def get_player_fixtures(fixtures: FplFixtures, player: FplPlayer) -> list[TeamFixture]:
    ...
    team_fixtures = [
        TeamFixture(
            ...
            opposition=fixture.team_h if fixture.team_a == team_id else fixture.team_a,
...
def predict_player_match_points(fixture: TeamFixture, rolling_points: float) -> float:
...
def predict_player_future_points(fixtures: list[TeamFixture], player: FplPlayer) -> list[PlayerExpectedPoints]:
    ...
    """
    rolling_data_filepath = DATA_FOLDER.joinpath("transformed").joinpath("rolling_points.csv")
    ...
    for fixture in fixtures:
        predicted_points = predict_player_match_points(fixture, player_rolling_points)
        player_expected_points.append(PlayerExpectedPoints(
            player=player,
            fixture=fixture,
...
def predict_all_players_future_points() -> list[PlayerExpectedPoints]:
    ...
    for player in players:
        ...
        player_expected_points.extend(predict_player_future_points(player_fixtures, player))
    return player_expected_points